...
function App() {
  ...
  return (
    <div className="flex h-[100dvh] bg-gray-50 overflow-hidden font-sans antialiased">
      ...
      <footer className="mt-8 py-10 flex flex-col items-center justify-center gap-4 bg-white border-t-2 border-black">
        <div className="text-black font-black uppercase tracking-widest text-sm text-center">
          @PratikHarkare06 <span className="text-gray-400 font-medium lowercase tracking-normal mx-2">proof of work, block by block</span>
        </div>
        <a 
          href="https://github.com/PratikHarkare06" 
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center gap-3 px-6 py-3 bg-[#1A1A1A] text-white rounded-[16px] border border-[#333333] hover:bg-[#252525] transition-all"
        >
          ...
          <span className="text-[15px] font-medium tracking-wide">View Profile</span>
        </a>
      </footer>
